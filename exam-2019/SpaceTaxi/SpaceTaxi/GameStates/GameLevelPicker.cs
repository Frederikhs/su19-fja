...
namespace SpaceTaxi.GameStates {
    public class GameLevelPicker : IGameState {
        ...
        /// <summary>
        /// Initialized the game state for the chosen level
        /// </summary>
        ...
        /// <summary>
        /// Render the Level Picker elements. (background and buttons)
        /// </summary>
        ...
        /// <summary>
        /// Initializes the required elements for the level picker
        /// </summary>
        public void InitializeGameState() {
            ...
            menuButtons = new[] {
                ...
                new Text("short-n-sweet", new Vec2F(0.2f, 0.2f), new Vec2F(0.5f, 0.3f)),
                new Text("the-beach", new Vec2F(0.2f, 0.3f), new Vec2F(0.5f, 0.3f))
            };
